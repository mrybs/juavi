...
#ifndef JUAVI_SIMPLE_WIDGETS_HPP
#define JUAVI_SIMPLE_WIDGETS_HPP

using namespace juavi;

namespace juavi{
    class juavi_simple_figures : public juavi_module{
    public:
      juavi_kernel* screen;
      juavi_simple_figures(const int x,const int y,const int aspect,juavi_kernel* screen) : juavi_module(x,y,aspect){
            this->screen = screen;
            this->aspect = aspect;
            this->x = x;
            this->y = y;
        }
        juavi_simple_figures(const int x,const int y,const int aspect,juavi_kernel* screen,const std::string background) : juavi_simple_figures(x,y,aspect,screen)
        {screen->setBackground(background);}

        juavi_simple_figures* drawRectangle(const int x,const int y,const int width,const int height,const std::string bgColor) {
        ...
        juavi_simple_figures* drawRectangle(const int x,const int y,const int width,const int height,const std::string color,const std::string background, bool useBackground) {
            for (int i = 0; i < int(x + width); i++) if (i >= (int)x && i <= (int)x + (int)width)
                for (int k = 0; k < int(y + height); k += (int(screen->getAspect()) - 1)) if (k >= y && k <= y + height)
                    screen->drawPoint(i, k, color, background);
            return this;
        }
        juavi_simple_figures* drawRectangle(const int x,const int y,const int width,const int height,const std::string color,const std::string bgColor) {
          for (int i = 0; i < int(x + width); i++) if (i >= (int)x && i <= (int)x + (int)width)
              for (int k = 0; k < int(y + height); k += (int(screen->getAspect()) - 1)) if (k >= y && k <= y + height)
                  screen->drawPoint(i, k, color, bgColor);
          return this;
        }
        juavi_simple_figures* drawRectangle(const int x,const int y,const int width,const int height,const std::string color,const std::string bgColor,const std::string background) {
        ...
        juavi_simple_figures* drawLine(const int x,const int y,const int size,bool vertical,const std::string color) {
          if (vertical) for(int i = y; i < size+y; i++) drawPoint(x,i,color);
          else for(int k = x; k < size+x; k++) drawPoint(k,y,color);
          return this;
        }
        juavi_simple_figures* drawLine(const int x,const int y,const int size,const bool vertical,const std::string color,const std::string background, bool useBackground) {
        ...
        juavi_simple_figures* drawLine(const int y,const int x,const int size,const bool vertical,const std::string color,const std::string bgColor) {
          if (vertical) for(int i = y; i < size+y; i++) drawPoint(x,i,color,bgColor);
          else for(int k = x; k < size+x; k++) drawPoint(k,y,color,bgColor);
          return this;
        }
        juavi_simple_figures* drawLine(const int x,const int y,const int size,const bool vertical,const std::string color,const std::string bgColor,const std::string background) {
        ...
        juavi_simple_figures* drawBorder(const float x,float y,const float width,const float height,float size,const std::string color) {
            if(size!=0){
        ...
        juavi_simple_figures* drawBorder(const float x,const float y,const float width,const float height,float size,const std::string color,const std::string background, bool useBackground) {
            if(size!=0){
                while(size >= width || size >= height)size-=1;
        ...
        juavi_simple_figures* drawBorder(const float x,float y,const float width,const float height,float size,const std::string color,const std::string bgColor) {
          if(size!=0){
            while(size >= width || size >= height)size-=1;
        ...
        juavi_simple_figures* drawBorder(const float x,const float y,const float width,const float height,float size,const std::string color,const std::string bgColor,const std::string background) {
          if(size!=0){
            while(size >= width || size >= height)size-=1;
        ...
        juavi_simple_figures* drawBackground(const std::string color) {
        ...
        juavi_simple_figures* drawBackground(const std::string color, const std::string backgroundd) {
